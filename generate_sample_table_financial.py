...
def generate_finance__field(num_records):
      dict_list = []
...
def generate_table_financial_build(dict, num_records):  
      pass

def generate_table_financial(min_rand_record_lim = 1, max_rand_record_lim = 100000):
      ...
      addr_data = generate_table_financial_build(addr_data, addr_num_records)
      return addr_data
